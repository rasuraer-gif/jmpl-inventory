...
const CryogenicModule = (() => {
  ...
  function pendingTab(batches) {
    if (!batches.length) return `<div class="card card-body"><div class="empty-state"><div class="empty-icon">&#10052;&#65039;</div><p>No batches in Cryogenic stage</p></div></div>`;
  ...
  function historyTab() {
    const recs = DB.StageRecords.byStage('cryogenic');
    ...
    return `<div class="card"><div class="card-header"><h3>Processing History</h3></div><div class="table-wrap"><table class="data-table"><thead><tr><th>Batch No</th><th>JMREF</th><th>Input</th><th>Output</th><th>Loss</th><th>Date</th></tr></thead><tbody>${rows}</tbody></table></div></div>`;
  }
